...
type Props = {
  ...
  onUpdateDoc: (docId: string, update: Pick<MaintenanceDoc, "status" | "notes" | "parts" | "workNotes" | "images">) => void;
...
function DocRow({
  ...
  doc: MaintenanceDoc;
  onUpdateDoc: (id: string, update: Pick<MaintenanceDoc, "status" | "notes" | "parts" | "workNotes" | "images">) => void;
            ...
            <div className="px-5 py-4 space-y-4">
              ...
              {doc.images.length > 0 && (
                <div>
                  ...
                  <ImageUploader images={doc.images} onChange={(imgs) => onUpdateDoc(doc.id, { status: doc.status, notes: doc.notes, parts: doc.parts, workNotes: doc.workNotes, images: imgs })} />
                </div>
              )}
